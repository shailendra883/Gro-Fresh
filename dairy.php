...
<head>
    ...
    <section class="section section-bg" id="call-to-action" style="background-image: url(assets/images/dairy1.jpeg)">
        <div class="container">
            <div class="row">
    ...
    <div class="row">
			...
			<?php
              ...
              $connect = get_db_connection();
				$query = "select * from products where pcategory='dairyproducts'";
				...
				?>
			<div class="col-lg-3">
				<form method="POST" action="dairy.php?action=add&id=<?php echo $row[0]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="dairy.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
