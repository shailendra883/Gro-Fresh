...
<head>
    ...
    <section class="section section-bg" id="call-to-action" style="background-image: url(assets/images/fruits.jpg)">
        <div class="container">
            <div class="row">
    ...
    <div class="row">
			...
			<?php
              ...
              $query = "select * from products where pcategory='fruitsveggies'";
				...
				?>
			<div class="col-lg-3">
				<form method="POST" action="vegetables.php?action=add&id=<?php echo $row[0]; ?>">
